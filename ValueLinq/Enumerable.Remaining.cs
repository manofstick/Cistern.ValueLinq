...
//        public static IEnumerable<TResult> Empty<TResult>() => System.Linq.Enumerable.Empty<TResult>();
        ...
        public static IEnumerable<TResult> GroupBy<TSource, TKey, TResult>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TKey, IEnumerable<TSource>, TResult> resultSelector) => System.Linq.Enumerable.GroupBy<TSource, TKey, TResult>(source, keySelector, resultSelector);
        public static IEnumerable<System.Linq.IGrouping<TKey, TElement>> GroupBy<TSource, TKey, TElement>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector) => System.Linq.Enumerable.GroupBy<TSource, TKey, TElement>(source, keySelector, elementSelector);
        public static IEnumerable<System.Linq.IGrouping<TKey, TSource>> GroupBy<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer) => System.Linq.Enumerable.GroupBy<TSource, TKey>(source, keySelector, comparer);
        public static IEnumerable<System.Linq.IGrouping<TKey, TSource>> GroupBy<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector) => System.Linq.Enumerable.GroupBy<TSource, TKey>(source, keySelector);
        public static IEnumerable<System.Linq.IGrouping<TKey, TElement>> GroupBy<TSource, TKey, TElement>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector, IEqualityComparer<TKey> comparer) => System.Linq.Enumerable.GroupBy<TSource, TKey, TElement>(source, keySelector, elementSelector, comparer);
        ...
        public static IEnumerable<TSource> Intersect<TSource>(this IEnumerable<TSource> first, IEnumerable<TSource> second) => System.Linq.Enumerable.Intersect<TSource>(first, second);
        public static IEnumerable<TSource> Intersect<TSource>(this IEnumerable<TSource> first, IEnumerable<TSource> second, IEqualityComparer<TSource> comparer) => System.Linq.Enumerable.Intersect<TSource>(first, second, comparer);
...
//        public static TSource Last<TSource>(this IEnumerable<TSource> source) => System.Linq.Enumerable.Last<TSource>(source);
        ...
        public static long LongCount<TSource>(this IEnumerable<TSource> source, Func<TSource, bool> predicate) => System.Linq.Enumerable.LongCount<TSource>(source, predicate);
...
//        public static IEnumerable<TResult> Select<TSource, TResult>(this IEnumerable<TSource> source, Func<TSource, int, TResult> selector) => System.Linq.Enumerable.Select<TSource, TResult>(source, selector);
        ...
        public static IEnumerable<TResult> SelectMany<TSource, TResult>(this IEnumerable<TSource> source, Func<TSource, int, IEnumerable<TResult>> selector) => System.Linq.Enumerable.SelectMany<TSource, TResult>(source, selector);
//        public static IEnumerable<TResult> SelectMany<TSource, TResult>(this IEnumerable<TSource> source, Func<TSource, IEnumerable<TResult>> selector) => System.Linq.Enumerable.SelectMany<TSource, TResult>(source, selector);
        ...
        public static bool SequenceEqual<TSource>(this IEnumerable<TSource> first, IEnumerable<TSource> second) => System.Linq.Enumerable.SequenceEqual<TSource>(first, second);
        public static bool SequenceEqual<TSource>(this IEnumerable<TSource> first, IEnumerable<TSource> second, IEqualityComparer<TSource> comparer) => System.Linq.Enumerable.SequenceEqual<TSource>(first, second, comparer);
...
//        public static int Sum(this IEnumerable<int> source) => System.Linq.Enumerable.Sum(source);
        ...
        public static System.Linq.IOrderedEnumerable<TSource> ThenBy<TSource, TKey>(this System.Linq.IOrderedEnumerable<TSource> source, Func<TSource, TKey> keySelector) => System.Linq.Enumerable.ThenBy<TSource, TKey>(source, keySelector);
        public static System.Linq.IOrderedEnumerable<TSource> ThenBy<TSource, TKey>(this System.Linq.IOrderedEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer) => System.Linq.Enumerable.ThenBy<TSource, TKey>(source, keySelector, comparer);
        public static System.Linq.IOrderedEnumerable<TSource> ThenByDescending<TSource, TKey>(this System.Linq.IOrderedEnumerable<TSource> source, Func<TSource, TKey> keySelector) => System.Linq.Enumerable.ThenByDescending<TSource, TKey>(source, keySelector);
        public static System.Linq.IOrderedEnumerable<TSource> ThenByDescending<TSource, TKey>(this System.Linq.IOrderedEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer) => System.Linq.Enumerable.ThenByDescending<TSource, TKey>(source, keySelector, comparer);
        public static TSource[] ToArray<TSource>(this IEnumerable<TSource> source) => System.Linq.Enumerable.ToArray<TSource>(source);
        public static Dictionary<TKey, TSource> ToDictionary<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector) => System.Linq.Enumerable.ToDictionary<TSource, TKey>(source, keySelector);
        public static Dictionary<TKey, TSource> ToDictionary<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer) => System.Linq.Enumerable.ToDictionary<TSource, TKey>(source, keySelector, comparer);
        public static Dictionary<TKey, TElement> ToDictionary<TSource, TKey, TElement>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector) => System.Linq.Enumerable.ToDictionary<TSource, TKey, TElement>(source, keySelector, elementSelector);
        public static Dictionary<TKey, TElement> ToDictionary<TSource, TKey, TElement>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector, IEqualityComparer<TKey> comparer) => System.Linq.Enumerable.ToDictionary<TSource, TKey, TElement>(source, keySelector, elementSelector, comparer);
        public static HashSet<TSource> ToHashSet<TSource>(this IEnumerable<TSource> source) => System.Linq.Enumerable.ToHashSet<TSource>(source);
        public static HashSet<TSource> ToHashSet<TSource>(this IEnumerable<TSource> source, IEqualityComparer<TSource> comparer) => System.Linq.Enumerable.ToHashSet<TSource>(source, comparer);
        ...
        public static System.Linq.ILookup<TKey, TElement> ToLookup<TSource, TKey, TElement>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector) => System.Linq.Enumerable.ToLookup<TSource, TKey, TElement>(source, keySelector, elementSelector);
        public static System.Linq.ILookup<TKey, TSource> ToLookup<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer) => System.Linq.Enumerable.ToLookup<TSource, TKey>(source, keySelector, comparer);
        public static System.Linq.ILookup<TKey, TSource> ToLookup<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector) => System.Linq.Enumerable.ToLookup<TSource, TKey>(source, keySelector);
        public static IEnumerable<TSource> Union<TSource>(this IEnumerable<TSource> first, IEnumerable<TSource> second) => System.Linq.Enumerable.Union<TSource>(first, second);
        public static IEnumerable<TSource> Union<TSource>(this IEnumerable<TSource> first, IEnumerable<TSource> second, IEqualityComparer<TSource> comparer) => System.Linq.Enumerable.Union<TSource>(first, second, comparer);
//        public static IEnumerable<TSource> Where<TSource>(this IEnumerable<TSource> source, Func<TSource, bool> predicate) => System.Linq.Enumerable.Where<TSource>(source, predicate);
        ...
        public static IEnumerable<(TFirst First, TSecond Second)> Zip<TFirst, TSecond>(this IEnumerable<TFirst> first, IEnumerable<TSecond> second) => System.Linq.Enumerable.Zip<TFirst, TSecond>(first, second);
        public static IEnumerable<TResult> Zip<TFirst, TSecond, TResult>(this IEnumerable<TFirst> first, IEnumerable<TSecond> second, Func<TFirst, TSecond, TResult> resultSelector) => System.Linq.Enumerable.Zip<TFirst, TSecond, TResult>(first, second, resultSelector);
    }
}
