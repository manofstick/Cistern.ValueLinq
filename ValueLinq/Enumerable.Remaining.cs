...
namespace Cistern.ValueLinq
{
    public static partial class Enumerable
    {
        ...
        [Obsolete("Not converted to ValueLinq yet")] public static TSource[] ToArray<TSource>(this IEnumerable<TSource> source) => System.Linq.Enumerable.ToArray<TSource>(source);
        ...
        [Obsolete("Not converted to ValueLinq yet")] public static IEnumerable<(TFirst First, TSecond Second)> Zip<TFirst, TSecond>(this IEnumerable<TFirst> first, IEnumerable<TSecond> second) => System.Linq.Enumerable.Zip<TFirst, TSecond>(first, second);
