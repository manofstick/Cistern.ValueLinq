...
{
    public class ToListUseStack : EnumerableTests
    {
        [Fact]
        public void ToList_AlwaysCreateACopy()
        {
            List<int> sourceList = new List<int>() { 1, 2, 3, 4, 5 };
            List<int> resultList = sourceList.ToListUseStack();
        ...
        {
            validation(Enumerable.ToListUseStack(items));
            validation(Enumerable.ToListUseStack(new List<T>(items)));
            validation(new TestEnumerable<T>(items).ToListUseStack());
            validation(new TestReadOnlyCollection<T>(items).ToListUseStack());
            validation(new TestCollection<T>(items).ToListUseStack());
        }
        ...
        public void RunOnce()
        {
            Assert.Equal(Enumerable.Range(3, 9), Enumerable.Range(3, 9).RunOnce().ToListUseStack());
        }
        ...
        public void ToList_TouchCountWithICollection()
        {
            ...
            var resultList = source.ToListUseStack();
        ...
        {
            int[] source = null;
            AssertExtensions.Throws<ArgumentNullException>("source", () => source.ToListUseStack());
        }
        ...
        public void ToList_ArrayWhereSelect(int[] sourceIntegers, string[] convertedStrings)
        {
            ...
            Assert.Equal(convertedList, sourceIntegers.Select(i => i.ToString()).ToListUseStack());

            Assert.Equal(sourceList, sourceIntegers.Where(i => true).ToListUseStack());
            Assert.Equal(emptyIntegersList, sourceIntegers.Where(i => false).ToListUseStack());

            Assert.Equal(convertedList, sourceIntegers.Where(i => true).Select(i => i.ToString()).ToListUseStack());
            Assert.Equal(emptyStringsList, sourceIntegers.Where(i => false).Select(i => i.ToString()).ToListUseStack());

            Assert.Equal(convertedList, sourceIntegers.Select(i => i.ToString()).Where(s => s != null).ToListUseStack());
            Assert.Equal(emptyStringsList, sourceIntegers.Select(i => i.ToString()).Where(s => s == null).ToListUseStack());
        }
        ...
        public void ToList_ListWhereSelect(int[] sourceIntegers, string[] convertedStrings)
        {
            ...
            Assert.Equal(convertedList, sourceList.Select(i => i.ToString()).ToListUseStack());

            Assert.Equal(sourceList, sourceList.Where(i => true).ToListUseStack());
            Assert.Equal(emptyIntegersList, sourceList.Where(i => false).ToListUseStack());

            Assert.Equal(convertedList, sourceList.Where(i => true).Select(i => i.ToString()).ToListUseStack());
            Assert.Equal(emptyStringsList, sourceList.Where(i => false).Select(i => i.ToString()).ToListUseStack());

            Assert.Equal(convertedList, sourceList.Select(i => i.ToString()).Where(s => s != null).ToListUseStack());
            Assert.Equal(emptyStringsList, sourceList.Select(i => i.ToString()).Where(s => s == null).ToListUseStack());
        }
        ...
        public void SameResultsRepeatCallsFromWhereOnIntQuery()
        {
            ...
            Assert.Equal(q.ToListUseStack(), q.ToListUseStack());
        }
        ...
        public void SourceIsEmptyICollectionT()
        {
            ...
            Assert.Empty(source.ToListUseStack());
            Assert.Empty(collection.ToListUseStack());
        }
        ...
        public void SourceIsICollectionTWithFewElements()
        {
            ...
            Assert.Equal(expected, source.ToListUseStack());
            Assert.Equal(expected, collection.ToListUseStack());
        }
        ...
        public void ConstantTimeCountPartitionSelectSameTypeToList()
        {
            ...
            Assert.Equal(new[] { 2, 4, 6, 8, 10 }, source.ToListUseStack());
        }
        ...
        public void ConstantTimeCountPartitionSelectDiffTypeToList()
        {
            ...
            Assert.Equal(new[] { "1", "2", "3", "4", "5" }, source.ToListUseStack());
        }
        ...
        public void DifferentOptions()
        {
            ...
            var a0 = source.ToListUseStack(maxStackItemCount: 0, arrayPoolInfo: (ArrayPool<int>.Shared, false));
            var a1 = source.ToListUseStack(maxStackItemCount: 100, arrayPoolInfo: (ArrayPool<int>.Shared, false));
            var a2 = source.ToListUseStack(maxStackItemCount: 0, arrayPoolInfo: null);
            var a3 = source.ToListUseStack(maxStackItemCount: 100, arrayPoolInfo: null);
